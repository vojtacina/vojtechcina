        ...
        <div className="w-full relative" > 
            <div className="main-bg w-full text-center  h-400px md:h-450px relative ">
                <div className={"z-20 flex flex-col items-center justify-center h-full transition duration-300 transform pb-30px "}>
                    ...
                    <div className="block w-2/3 text-gray-200" >opravy, servis, zrychlení a poradenství <span className="uppercase px-4px py-2px bg-green-500 font-semibold rounded text-white text-14">KDYKOLIV</span>.</div>
                </div>
