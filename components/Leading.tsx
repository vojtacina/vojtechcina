...
export default function Leading() {
    ...
    return (
        <div className="w-full relative" > 
            <div className="main-bg w-full text-center h-300px md:h-400px  relative ">
                <div className={"z-20 flex flex-col items-center justify-center h-full transition duration-300 transform pt-60px "}>
