...
export default function Leading() {
    ...
    return (
        <div className="w-full relative" > 
            <div className="main-bg w-full text-center  h-400px  relative ">
                <div className={"z-20 flex flex-col items-center justify-center h-full transition duration-300 transform pb-30px "}>
                    <div className="block text-gray-400">Jsem </div>
                    <div className="text-24 sm:text-36 lg:text-55 xl:text-64  font-semibold block w-full px-12px font-quicksand"><h1>Grafik a webový vývojář</h1></div>
