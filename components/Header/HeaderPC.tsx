    ...
    return (
        <div className={"w-full flex p-16px fixed top-0 items-center z-50 transition duration-1000 " + (!visible && "backdrop")}>
            <div className="w-200px md:w-250px relative appear h-40px">
                <Image alt='Logo' src="/img/Logo.svg" layout="fill" objectFit="contain" />

            </div>
            <div className="w-full flex justify-end items-center text-14 md:text-16">
                <Link href="tel:+420774148327">
                    <div className="text-center text-16 font-regular h-45px bg-emerald-500 flex items-center justify-center px-20px rounded-lg my-10px font-medium select-none cursor-pointer hover:bg-emerald-400">774 148 327</div>
                </Link>
